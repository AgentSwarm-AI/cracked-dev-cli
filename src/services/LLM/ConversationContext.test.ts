...
describe("ConversationContext", () => {
  ...
  it("should add a message to the conversation history", () => {
    ...
    expect(conversationContext.getMessages()).toContainEqual({ role: "user", content: "Hello, Assistant!" });
  });
  ...
  it("should set system instructions correctly", () => {
    conversationContext.setSystemInstructions("You are a helpful assistant.");
    expect(conversationContext["systemInstructions"]).toBe("You are a helpful assistant.");
  });
});